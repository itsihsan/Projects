...
noise_std = 3.75 ; % standard deviation of noise in dBm.
% noise_std = 3.16227766; % standard deviation of noise in mW.
% gamma = 2.29; % free pathloss exponent.
gamma = 2.2; % free pathloss exponent.
% 3 verifiers
verifier_loc =  [0,0;
    -25.5227239497835,47.6959555811359;
    -8.59996258991773,-46.919550686348];
